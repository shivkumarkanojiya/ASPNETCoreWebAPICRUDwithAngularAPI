...
namespace WebAPICRUDwithDotNetCore.Controllers
{
    ...
    public class DesignationController : ControllerBase
    {
        ...
        {
            if (id != tblDesignation.DesignationID)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<TblDesignation>> PostTblDesignation(TblDesignation tblDesignation)
        {
            ...
            return CreatedAtAction("GetTblDesignation", new { id = tblDesignation.DesignationID }, tblDesignation);
        }
        ...
        {
            return _context.TblDesignation.Any(e => e.DesignationID == id);
        }
    }
}
